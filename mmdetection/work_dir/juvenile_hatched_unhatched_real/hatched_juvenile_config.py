...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        'demo/200224/training/annotations/instances_default_juvenile_unhatched.json',
        img_prefix='demo/200224/training/images',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(
...
classes = ('Hatched', 'Unhatched', 'Juvenile')
seed = 0
work_dir = 'work_dir/juvenile_hatched_unhatched_real'
auto_resume = False
gpu_ids = [0]
